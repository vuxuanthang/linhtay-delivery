...
describe('Service Tests', () => {
    ...
    describe('CategoryBlockMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CategoryBlockMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/category-blocks';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CategoryBlockMySuffix', () => {
